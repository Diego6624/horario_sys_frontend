const CardHorarioComponent = ({
    ...
    return (
        <div className="bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 flex flex-col min-w-[260px] h-full">

            {/* HEADER */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-center py-5 px-10 rounded-t-2xl">
