...
const Info = ({ label, value }) => (
  <div className="flex flex-col">
    <span className="text-gray-500 font-semibold uppercase tracking-wide text-xs sm:text-sm md:text-md xl:text-xl" >
      {label}
    </span>
    <span className="font-medium text-gray-800 text-sm sm:text-base md:text-lg xl:text-2xl">
      {value}
    </span>
  </div>
);
